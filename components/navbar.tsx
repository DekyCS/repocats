  ...
  menu = [
      ...
      items: [
        {
          ...
          description: "Analyze and understand repository metrics",
        ...
        {
          title: "Analytics",
          description: "Track your repository performance",
    ...
    },
    {
      ...
      items: [
        {
          title: "Documentation",
          description: "Learn how to use RepoCats effectively",
          icon: <Zap className="size-5 shrink-0" />,
          url: "#",
        },
        {
        ...
        {
          title: "API",
          description: "Integrate RepoCats with your own applications",
          icon: <Trees className="size-5 shrink-0" />,
          url: "#",
        },
        {
